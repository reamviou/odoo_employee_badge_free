...
class VitouHREmployeeExpiredOnCard(models.Model):
     ...
     vitouhr_card_border = fields.Boolean(string='Card Border', default=True, store=True)
     vitouhr_border_round = fields.Integer(string='Border Rounded (px)', default=10, store=True)
     ...
     vitouhr_is_qrcode = fields.Boolean(string='Is Qrcode', default=True, store=True)



     # def print_badge_portrait(self):
     #      return self.open_report_all('vitou_employee_badge_free.vitouhr_print_employee_badge', 'My Custom Report')
     #
     #
